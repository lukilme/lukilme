...
<template >
  <div class="w-full font-mono bg-white text-black overflow-x-hidden py-15">
    <div class="fixed inset-0 pointer-events-none z-0">
      <div class="absolute w-16 h-16 bg-pink-500 border-4 border-black top-[10%] left-[10%] float-1"></div>
      <div class="absolute w-20 h-20 bg-yellow-500 border-4 border-black rounded-full top-[70%] right-[15%] float-2"></div>
      <div class="absolute w-10 h-24 bg-purple-500 border-4 border-black top-[40%] right-[5%] float-3"></div>
      <div class="absolute w-24 h-10 bg-blue-500 border-4 border-black bottom-[20%] left-[5%] float-4"></div>
    </div>

    <div class="chaos-text fixed top-[20%] left-0 text-sm font-bold opacity-10 pointer-events-none">CODE</div>
    <div
